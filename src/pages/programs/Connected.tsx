  ...
  return (
    <>
      <SEO
        ...
        description="The Connected program at Alif Global School builds bridges between students, alumni, and industry experts through networking and mentorship."
        canonical="/programs/connected"
        breadcrumbs={[
          { name: 'Home', path: '/' },
